...
function ProductList(_a) {
    ...
    return (React.createElement(Grid_1["default"], { container: true, spacing: 4, sx: {
            mt: 2,
            mx: "auto",
            width: "100%",
            maxWidth: "1200px",
            px: { xs: 1, sm: 2, md: 3 }
        } }, products === null || products === void 0 ? void 0 : products.map(function (product) { return (React.createElement(Grid_1["default"], { size: { xs: 6, sm: 3 }, key: product.id },
